...
const signPath = (id: string) => `/api/documents/${id}/sign`;
...
export async function POST(
  ...
  try {
    ...
    const response = await fetch(buildBackendUrl(backendUrl, signPath(id)), {
      method: 'POST',
      headers: {
    ...
    console.error('[API PROXY /api/documents/:id/sign POST]', error);
    const message =

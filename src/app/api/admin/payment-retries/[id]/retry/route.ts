...
export async function POST(
  ...
  try {
    ...
    const backendResponse = await fetch(`${backendUrl}/api/admin/payment-retries/${id}/retry`, {
      method: 'POST',
      headers,
      cache: 'no-store'
    });
    ...
    console.error(`[API PROXY /api/admin/payment-retries/:id/retry POST] Error:`, error);

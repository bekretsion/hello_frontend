...
import { Sparkles, Bot, Building } from 'lucide-react';
                ...
                <div className="w-full max-w-md mx-auto animate-in fade-in slide-in-from-bottom duration-700">
                    ...
                    <div className="mt-8 text-center text-white/80">
                        <div className="flex items-center justify-center gap-2 mb-2">
                            ...
                            <span className="font-semibold text-white">Business Setup</span>
                        </div>
                        <p className="text-sm">We're helping you build the future of your AI communication.</p>
                    </div>
                </div>
            </div>
        </div>
